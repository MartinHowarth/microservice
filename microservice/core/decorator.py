...
from microservice.core import settings, kube
...
def microservice(func):
    ...
    def runtime_discovery(*args, **kwargs):
        ...
        print("Function being discovered is:", service_name)
...
def robust_service_call(service_name):
    ...
    def robust_call(*args, **kwargs):
        service_func = settings.ServiceWaypost.locate(service_name)
        if settings.deployment_type == settings.DeploymentType.ZERO:
            return settings.ServiceWaypost.service_functions[service_uri]
